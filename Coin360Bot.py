...
# we need this to check if a user has manage_messages permission
...
async def on_ready() -> None:
    ...
    print("Invite link: https://discord.com/oauth2/authorize?client_id={}&scope=bot+applications.commands&permissions=2147600384".format(bot.user.id))
    print("-------------------")
    status_task.start()
    await bot.tree.sync()
...
async def status_task() -> None:
    ...
    """
    statuses = ["/viewcoin360", "/coin360channel"]
